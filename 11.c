...
*
 ...
 And when the player hits enter it starts the game
 Hitting Enter in the game also makes it exit to the
 Main menu (will make more sophisticated later)
 Make sure that when you enter the game each time, it resets
 the game data to some initial state (like scores being zeroes and paddles being centered)
*/
