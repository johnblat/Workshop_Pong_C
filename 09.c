...
//
//
// I'm going to include notes about logic for how the ball should
// actually be bouncing off the paddle.

// Essentially:
// If the ball hits the center of the paddle -> 
//	ball bounces away at 0 degrees
// If the ball hits the top of the paddle ->
//	ball boucnes away at 75 degrees
// If the ball hits the bottom of the paddle ->
//	ball bounces away at -75 degrees
// If the ball hits anywhere in between the top and
// bottom of the paddle ->
//	the ball's bounce angle should be calculated by taking some
