/**
Some finishing touches on the playfield design.

Do the following:
- Track the p1 and p2 score somehow
- Reset the ball to something sensible when one player gets a goal
- Display the score for each player on their side of the board
- Draw a Line down the middle of the playfield like its the net of a tennis court
*/
