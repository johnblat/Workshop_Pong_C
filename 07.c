...
//
// Now make the ball move diagonally
// If the ball goes out of bounds in the left or right side of screen, make the "re-spawn"
// in the center of the screen
//
// Keep the bouncing on the top and bottom of the screen
// Change the ball speed between positive and negative between program runs to test that this works for both sides of the screen
//
// Hint: you may need two "speed" values for x and y
